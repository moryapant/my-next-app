        ...
        <div className="space-y-4">
            {posts.map(post => (
                <div key={post.id} className="bg-white dark:bg-gray-800 rounded-lg shadow">
                    <Link href={`/subfapps/${post.subfappName.toLowerCase()}/posts/${post.id}`} className="block p-4 hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <p className="mt-2 text-gray-600 dark:text-gray-300 line-clamp-3">{post.content}</p>
                        ...
                        <div className="mt-4 flex items-center text-sm text-gray-500 dark:text-gray-400">
                            <div className="flex items-center">
                                <span className="mr-2">{post.votes} votes</span>
                                <span className="mx-2">•</span>
